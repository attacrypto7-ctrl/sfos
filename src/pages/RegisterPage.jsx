...
export default function RegisterPage() {
  const { setUser, setLoggedIn, showToast } = useApp();
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await registerApi({ name, phone, email, password });
      setUser(data.user);
      setLoggedIn(true);
      showToast('Akun berhasil dibuat! Selamat datang di Tanamanku 🌱', 'success');
      navigate('/dashboard');
    } catch (err) {
      ...
      <div className="auth-layout">
        ...
        <div className="auth-panel-left" role="complementary" aria-label="Informasi pendaftaran">
          ...
          <div className="auth-illustration" aria-hidden="true">
            <svg viewBox="0 0 360 280" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <circle cx="100" cy="60" r="3" fill="rgba(255,255,255,0.5)" />
              <circle cx="280" cy="80" r="2" fill="rgba(255,255,255,0.4)" />
              <circle cx="320" cy="50" r="3.5" fill="rgba(255,255,255,0.35)" />
          ...
          <div className="auth-features" role="list">
            <div className="auth-feature-item" role="listitem">
              ...
              <span>Gratis untuk 30 hari pertama</span>
            </div>
            <div className="auth-feature-item" role="listitem">
              <div className="auth-feature-icon" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
              ...
              <span>Kelola tanpa batas dalam masa trial</span>
            </div>
            <div className="auth-feature-item" role="listitem">
              <div className="auth-feature-icon" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
        ...
        <div className="auth-panel-right" role="main">
          ...
          <div className="auth-header">
            ...
            <p>Daftarkan dirimu dan mulai jaga kebunmu bersama Tanamanku.</p>
          </div>
            ...
            <div className="form-group">
              ...
              <div className="password-strength" id="password-strength" aria-live="polite">
                <div className="password-strength-bar">
                  <div className={`strength-seg ${password ? getStrengthClass() : ''}`} aria-hidden="true"></div>
                  <div className={`strength-seg ${password && strengthScore >= 2 ? getStrengthClass() : ''}`} aria-hidden="true"></div>
                  <div className={`strength-seg ${password && strengthScore >= 3 ? getStrengthClass() : ''}`} aria-hidden="true"></div>
                  <div className={`strength-seg ${password && strengthScore >= 4 ? getStrengthClass() : ''}`} aria-hidden="true"></div>
                </div>
                <span className="strength-label" id="strength-label">{password ? strengthLabel : ''}</span>
              </div>
            </div>
