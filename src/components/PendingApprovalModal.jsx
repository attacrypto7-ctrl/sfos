 ...
 *   supportPhone — nomor CS dari API (misal "6285215002047" atau "085215002047")
 *                  Jika tidak ada, tombol WhatsApp tidak ditampilkan.
 */
export default function PendingApprovalModal({ onClose, supportPhone }) {
  // Bangun URL WhatsApp dari supportPhone yang dikirim API.
  // Normalisasi: hapus karakter non-digit, awalan 62 untuk Indonesia.
